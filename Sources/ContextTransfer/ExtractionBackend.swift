...
///
/// PROMPT DRIFT WARNING: the canonical copy of this template lives in
/// /prompt/extraction-template.md at the repo root, which also feeds the
/// Node CLI (cli/src/prompt.js, generated by cli/sync-prompt.js). This Swift
/// copy is manually synced — if you change the template, update it here AND
/// in /prompt/extraction-template.md in the same commit.
